// /Real-Estate-Marketplace/acrea/src/views/FavoritedProperties/FavoritedProperties.jsx
...
function FavoritedProperties() {
    ...
    return (
        <div className={`screen ${Styles.favoritedPropertiesScreen}`}>
            <Header />
            <SecondHeader/>
            <div style={{textAlign:'center', justifyContent:'center', flexDirection:'column'}}>
            <h2 >Your Favorited Properties</h2>
                <div className={Styles.favoritedPropertiesScreenContainer}>
                    {favorites.length > 0 ? (
                        favorites.map((property, index) => (
                            <PropertiesCardVertical key={index} property={property} />
                        ))
                    ) : (
                        <p>No favorited properties found.</p>
                    )}
